defmodule FafCnWeb.EcoWorkflow.PowerRateNode do
  @moduledoc """
  Power Rate Node - Shows power/energy income, drain, and net production rate.
  """
  ...
  def render(assigns) do
    ...
    <div class="workflow-node">
      <div class="workflow-node-header workflow-node-power">
        ...
        <span>{@node.data[:label] || "Power Rate"}</span>
      </div>
      <div class="workflow-node-body">
        ...
        <div class={[
          ...
          if(@net_positive, do: "text-power", else: "text-error")
        ]}>
